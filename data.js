...
const VILLAGES = [
  ...
  { id: "kaminomine", name: "神之嶺", kana: "かみのみね", town: "tokunoshima", x: 86.9, y: 82.1  , note: "井之川と諸田の間に位置する東海岸の集落" },
  { id: "tokuwase", name: "徳和瀬", kana: "とくわせ", town: "tokunoshima", x: 89.7, y: 90.0  , note: "亀徳港の北隣、海沿いに家並みが続く集落" },
