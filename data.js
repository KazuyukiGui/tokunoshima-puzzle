...
const VILLAGES = [
  ...
  { id: "tankawa", name: "反川", kana: "たんかわ", town: "tokunoshima", x: 64.7, y: 62.1   , note: "奄美伝統のトゥール墓が受け継がれる集落" },
  { id: "oatari", name: "大当", kana: "おおあたり", town: "tokunoshima", x: 62.5, y: 58.5   , note: "約170本のヒカンザクラが並ぶ花見の里" },
  { id: "ikema", name: "池間", kana: "いけま", town: "tokunoshima", x: 68.8, y: 62.5   , note: "町指定無形文化財・池間棒踊りを受け継ぐ集落" },
  { id: "shimokushi", name: "下久志", kana: "しもくし", town: "tokunoshima", x: 72.9, y: 64.7   , note: "サンゴ礁の潮だまり観察が楽しい下久志海浜公園" },
  ...
  { id: "kaminomine", name: "神之嶺", kana: "かみのみね", town: "tokunoshima", x: 86.9, y: 82.1   , note: "集落の守護神を祀る祠カンニンウシシギャデラ" },
  { id: "tokuwase", name: "徳和瀬", kana: "とくわせ", town: "tokunoshima", x: 89.7, y: 90.0   , note: "レジャープールがある健康の森総合運動公園の里" },
  { id: "kametoku", name: "亀徳", kana: "かめとく", town: "tokunoshima", x: 85.8, y: 99.4   , note: "鹿児島〜沖縄航路のフェリーが発着する島の玄関口" },
  { id: "kametsu", name: "亀津", kana: "かめつ", town: "tokunoshima", x: 77.2, y: 113.4   , note: "飲食店が集まる島一番の繁華街。学士村の歴史も" },
  { id: "shirai", name: "白井", kana: "しらい", town: "tokunoshima", x: 53.3, y: 106.2   , note: "目手久からの移住伝承を伝える氏神・白井神社" },
  { id: "ohara", name: "大原", kana: "おおはら", town: "tokunoshima", x: 60.5, y: 102.2   , note: "井之川岳へ緩やかに登る大原ルートの玄関口" },
  { id: "nanbaru", name: "南原", kana: "なんばる", town: "tokunoshima", x: 74.2, y: 123.6   , note: "約1億年前の海底火山が生んだ枕状溶岩の海岸" },
  { id: "omo", name: "尾母", kana: "おも", town: "tokunoshima", x: 67.4, y: 117.8   , note: "松明を掲げて踊る伝統行事「アキムチ」の里" },

  // ===== 天城町 =====
  { id: "yonama", name: "与名間", kana: "よなま", town: "amagi", x: 16.3, y: 17.5   , note: "花崗岩の奇景ムシロ瀬と与名間ビーチ、尚子ロード" },
  { id: "matsubara", name: "松原", kana: "まつばら", town: "amagi", x: 16.9, y: 32.2   , note: "銅山跡の遊歩道から海を望む松原銅山跡地公園" },
  ...
  { id: "hetono", name: "平土野", kana: "へとの", town: "amagi", x: 14.9, y: 57.7   , note: "町の中心地。商店街では壁画アート巡りも楽しい" },
  ...
  { id: "tobe", name: "当部", kana: "とうべ", town: "amagi", x: 36.5, y: 70.0   , note: "クロウサギ観察小屋と名水・東又泉がある癒しの里" },
  { id: "otsukawa", name: "大津川", kana: "おおつかわ", town: "amagi", x: 19.2, y: 71.0   , note: "当部へ抜ける道に桜を植え、桜街道を育てる集落" },
  ...
  { id: "kawachi", name: "河地", kana: "かわち", town: "isen", x: 29.6, y: 105.4   , note: "県道沿いの無人市場で島の野菜に出会える" },
  ...
  { id: "uebaru", name: "上晴", kana: "うえばる", town: "isen", x: 25.8, y: 112.1, approx: true   , note: "崎原の隣、伊仙町西部ののどかな集落" },
  { id: "nakayama", name: "中山", kana: "なかやま", town: "isen", x: 48.3, y: 119.1   , note: "町内最小の集落。田植え歌と踊りを受け継ぐ" },
  { id: "isen", name: "伊仙", kana: "いせん", town: "isen", x: 39.2, y: 146.5   , note: "歴史民俗資料館と温水プールのほーらい館がある" },
  { id: "kenbuku", name: "検福", kana: "けんぶく", town: "isen", x: 47.3, y: 144.9   , note: "商店やゲストハウスがあり滞在の拠点にも便利" },
